...
export function RubricProgressMap({ onGoToLesson }: RubricProgressMapProps) {
  ...
  return (
    <div className="no-print glass-panel rounded-2xl border border-blue-100/40 dark:border-blue-900/30 p-4 sm:p-5 space-y-3">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-2.5 py-2 rounded-xl text-left text-[11px] font-semibold transition-all cursor-pointer border ${
                complete
                  ...
                  : 'bg-white/80 dark:bg-slate-900/60 border-slate-100 dark:border-slate-800/80 text-slate-600 dark:text-slate-300 hover:border-blue-200 dark:hover:border-blue-500/50 hover:bg-blue-50/50 dark:hover:bg-slate-850/50'
              }`}
            >
              <span
