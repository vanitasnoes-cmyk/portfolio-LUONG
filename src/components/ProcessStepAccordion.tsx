...
function getStepBadges(text: string, evidence: StepEvidence) {
  ...
  if (
    ...
    badges.push({
      ...
      className: 'bg-blue-50 text-blue-800 border-blue-200/80 dark:bg-blue-950/30 dark:text-blue-400 dark:border-blue-900/30',
      icon: 'ai',
    });
  }
      ...
      {steps.map((step, idx) => {
        ...
        return (
          ...
          >
            ...
            >
              <span className="w-7 h-7 rounded-lg bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-400 text-[11px] font-black flex items-center justify-center shrink-0 border border-blue-100/60 dark:border-blue-900/40">
                {stepNum}
              </span>
